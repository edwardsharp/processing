...
String filename = "orange1_hydro_3dprint01_2min15s_22050.txt";
...
//parameters
float samplingRate = 22050;//44100;//(44.1khz audio initially)
float rpm = 33.3;//rev per min
float secPerMin = 60;//seconds per minute
float rateDivisor = 4;//16;//29;//18;//6;16;//4;//how much we are downsampling by
...
float diameter = 5.9;//11.8;//diameter of record in inches
float innerHole = 0.286;//diameter of center hole in inches
float innerRad = 1.5;//2.35;//radius of innermost groove in inches
float outerRad = 2.9;//5.75;//radius of outermost groove in inches

//record parameters
float recordHeight = 0.15;//height of record in inches
...
void setup(){
  ...
  geo.writeSTL(this, name + "_nov24___6in.stl");//write stl file from geomtery
